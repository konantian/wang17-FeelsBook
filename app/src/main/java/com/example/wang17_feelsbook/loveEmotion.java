...
public class loveEmotion extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_love_emotion);
        ...
        EditText editText= findViewById(R.id.love_comment);
    ...
    public void cancel(View view){
        ...
        Intent intent = new Intent(loveEmotion.this, MainActivity.class);
